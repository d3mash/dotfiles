...
(let* ((class '((class color) (min-colors 89)))
       ...
       (minibuffer cursor)
       (region "grey90")
       (comment-delimiter "black")
       (comment "black")
       (constant foreground)
       (string "grey10")
       (modeline-foreground foreground)
       (modeline-background "grey85")
  ...
  (custom-theme-set-faces
   ...
   ;; minibuffer
   `(minibuffer-prompt ((,class (:foreground ,minibuffer :weight normal))))
   ...
   ;; faces
   `(font-lock-builtin-face ((,class (:foreground ,foreground :weight normal))))
   `(font-lock-constant-face ((,class (:foreground ,foreground :weight normal))))
   `(font-lock-keyword-face ((,class (:foreground ,foreground :weight normal))))
   `(font-lock-type-face ((,class (:foreground ,foreground :slant italic))))
   `(font-lock-function-name-face ((,class (:foreground ,foreground :weight normal))))
